...
export class ProgramsService {
  ...
  public obtenerProgram(): Observable<Program[]> {
    ...
    return this.http.get<Program[]>(this.url.concat('/api/tours/web/get'), { headers })
  }

  public deleteProgram(id: number): Observable<any[]> {
    const headers = new HttpHeaders().set('Authorization', localStorage.getItem('token'));
    const params = new HttpParams().set('id', id.toString());
    return this.http.delete<any[]>(this.url.concat('/api/tours/web/delete'), { headers, params })
  }
  ...
  public programCreate(coordinator: Program): Observable<any> {
    ...
    return this.http.post(this.url.concat('/api/tours/web/create'), JSON.stringify(coordinator), { headers });
  }
  ...
  public programUpdate(coordinator: Program, id: String): Observable<any> {
    ...
    return this.http.post(this.url.concat('/api/tours/web/update'), JSON.stringify(coordinator), { headers, params });
  }
  ...
  public addProgramPackage(tourPackage: TourPackage, id: String): Observable<any> {
    ...
    return this.http.post(this.url.concat('/api/touradd/web/package/create'), JSON.stringify(tourPackage), { headers, params });
  }
  ...
  public addProgramActivities(tourActivities: TourActivities, id: String): Observable<any> {
    ...
    return this.http.post(this.url.concat('/api/touradd/web/activities/create'), JSON.stringify(tourActivities), { headers, params });
  }

  public listActivitiesProgram(id: String): Observable<ClientAddActivities[]> {
    const headers = new HttpHeaders().set('Authorization', localStorage.getItem('token'));
    const params = new HttpParams().set('id', id.toString());
    return this.http.get<ClientAddActivities[]>(this.url.concat('/api/touradd/web/activities/getlist'), { headers, params })
  ...
  public activitiesProgramDeleteList(id: number): Observable<any[]> {
    const headers = new HttpHeaders().set('Authorization', localStorage.getItem('token'));
    const params = new HttpParams().set('id', id.toString());
    return this.http.delete<any[]>(this.url.concat('/api/touradd/web/activities/deleteList'), { headers, params })
