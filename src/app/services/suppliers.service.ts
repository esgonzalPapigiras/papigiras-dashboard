...
export class SuppliersService {
  ...
  public obtenerSuppliers(): Observable<Suppliers[]> {
    ...
    return this.http.get<Suppliers[]>(this.url.concat('/api/suppliers/web/get'), { headers })
  }

  public listStatusTour(): Observable<statusTour[]> {
    const headers = new HttpHeaders().set('Authorization', localStorage.getItem('token'));
    return this.http.get<statusTour[]>(this.url.concat('/api/suppliers/web/get'), { headers })
  }

  public deletesuppliers(id: number): Observable<any[]> {
    const headers = new HttpHeaders().set('Authorization', localStorage.getItem('token'));
    const params = new HttpParams().set('id', id.toString());
    return this.http.delete<any[]>(this.url.concat('/api/suppliers/web/delete'), { headers, params })
  }
  ...
  public suppliersCreate(coordinator: Suppliers): Observable<any> {
    ...
    return this.http.post(this.url.concat('/api/suppliers/web/create'), JSON.stringify(coordinator), { headers });
  }
  ...
  public suppliersUpdate(coordinator: Suppliers, id: String): Observable<any> {
    ...
    return this.http.post(this.url.concat('/api/suppliers/web/update'), JSON.stringify(coordinator), { headers, params });
  }
}
